                ...
                <table className="data-table">
                    ...
                    {applyFilters ( machines ).map ( machine => (
                        <tr key={machine.serial_number}>
                            <td><Link
                                to={`/references/${machine.model.directory_name}/${machine.model.name}`}>{machine.model.name}</Link>
                            </td>
                            <td>{machine.serial_number}</td>
                            <td><Link
                                to={`/references/${machine.engine_model.directory_name}/${machine.engine_model.name}`}>{machine.engine_model.name}</Link>
                            </td>
                            <td>{machine.engine_serial_number}</td>
                            <td><Link
                                to={`/references/${machine.transmission_model.directory_name}/${machine.transmission_model.name}`}>{machine.transmission_model.name}</Link>
                            </td>
                            <td>{machine.transmission_serial_number}</td>
                            <td><Link
                                to={`/references/${machine.driving_axle_model.directory_name}/${machine.driving_axle_model.name}`}>{machine.driving_axle_model.name}</Link>
                            </td>
                            <td>{machine.driving_axle_serial_number}</td>
                            <td><Link
                                to={`/references/${machine.steering_axle_model.directory_name}/${machine.steering_axle_model.name}`}>{machine.steering_axle_model.name}</Link>
                            </td>
