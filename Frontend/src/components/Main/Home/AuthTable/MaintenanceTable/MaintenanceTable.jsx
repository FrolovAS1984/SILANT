            ...
            <tr key={index}>
                <td>
                    <a href="#!" className="link-button"
                       onClick={() => handleSerialNumberClick ( item.machine_serial_number )}>
        ...
        <>
            ...
            <div className="filter-container">
                <label className="label">
                    Вид ТО:
                    <select className="select-label" name="maintenanceType" value={filters.maintenanceType}
                ...
                <label className="label">
                    Зав. номер машины:
                    <select className="select-label" name="serialNumber" value={filters.serialNumber}
                            onChange={handleFilterChange}>
                        <option value="">Все</option>
