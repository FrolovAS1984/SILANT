    ...
    useEffect ( () => {
        const applyFilters = () => {
            const filtered = data.filter ( item => {
                ...
                const matchesServiceCompany = filters.serviceCompany === '' || item.service_companies.some ( company => company.company_name === filters.serviceCompany );
    ...
    return (
        <>
            ...
            <div className="filter-container">
                <label>
                    Узел отказа:
                    <select className="select-label" name="failureNode" value={filters.failureNode}
                ...
                <label>
                    ...
                    <select className="select-label" name="restorationMethod" value={filters.restorationMethod}
                            onChange={handleFilterChange}>
                        <option value="">Все</option>
                ...
                <label>
                    Сервисная компания:
                    <select className="select-label" name="serviceCompany" value={filters.serviceCompany}
                            onChange={handleFilterChange}>
                        <option value="">Все</option>
                        {Array.from ( new Set ( data.flatMap ( item => item.service_companies.map ( company => company.company_name ) ) ) ).map ( (company , index) => (
                ...
                {error ? (
                    ...
                    <table className="data-table">
                        ...
                        <tr>
                            ...
                            <th>Используемые <br/> запасные части</th>
